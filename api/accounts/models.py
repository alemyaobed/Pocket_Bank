...
#         extra_fields.setdefault('entity_type', None)
...
#     entity_type = models.ForeignKey('Entity_type', on_delete=models.SET_NULL, null=True)
#     address = models.TextField(blank=False, null=False)
#     phone_number = models.CharField(max_length=20, unique=True, null=False)
#     branch = models.ForeignKey('core.Branch', on_delete=models.SET_NULL, null=False)
